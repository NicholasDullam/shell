...
void expandWildcard(char* prefix, char* suffix) {
  ...
  *r='$'; r++; *r=0;
  ...
  while ( (ent = readdir(dir))!= NULL) {
    ...
    regmatch_t match;
    printf("%s", prefix);
    if (regexec(&re, ent->d_name, 1, &match, 0) == 0 && !(suffix[0] != 0 && ent->d_type == DT_DIR)) {
      if (ent->d_name[0] == '.') {
        if (component[0] == '.') {
...
{
       0,   252,   252,   256,   257,   260,   264,   268,   269,   273,
     280,   281,   285,   297,   305,   313,   323,   329,   334,   338,
     345,   346,   350,   351,   355,   358
};
#endif
...
{
  "$end", "error", "$undefined", "WORD", "NOTOKEN", "GREAT", "GREATGREAT",
  "GREATAMPERSAND", "GREATGREATAMPERSAND", "TWOGREAT", "NEWLINE", "PIPE",
  "AMPERSAND", "LESS", "$accept", "goal", "commands", "command",
  "simple_command", "command_and_args", "argument_list", "argument",
  "command_word", "iomodifier_opt", "iomodifier_opt_list", "pipe_list",
...
{
       1,    -5,    -6,    -6,     6,     0,    -6,    -6,    -6,    -6,
      -4,    -6,    -6,    -6,     5,    14,     7,    -6,    -6,    -6,
      15,    18,    19,    20,    21,    -6,    22,    -6,    -1,    -6,
      -6,    -6,    -6,    -6,    -6,    -6
};
...
static const yytype_uint8 yydefact[] =
{
      ...
      21,     8,     1,     4,     9,     0,    25,    12,    10,    22,
       0,     0,     0,     0,     0,    24,     0,    20,     0,    14,
      15,    17,    16,    18,    19,     6
};
...
{
      -2,     1,     1,     2,     2,    11,    12,    15,    17,    35,
       3,     3,    20,    21,    22,    23,    24,     2,    29,    25,
      26,    30,    31,    32,    33,    34,    19,     0,    13
};

static const yytype_int8 yycheck[] =
{
       0,     1,     1,     3,     3,    10,     0,    11,     3,    10,
      10,    10,     5,     6,     7,     8,     9,     3,     3,    12,
      13,     3,     3,     3,     3,     3,    15,    -1,     5
};
...
{
       0,     1,     3,    10,    15,    16,    17,    18,    19,    22,
      25,    10,     0,    17,    20,    11,    24,     3,    21,    19,
       5,     6,     7,     8,     9,    12,    13,    23,    26,     3,
       3,     3,     3,     3,     3,    10
};
...
#line 1475 "y.tab.cc" /* yacc.c:1646  */
    break;

  case 8:
#line 269 "shell.y" /* yacc.c:1646  */
    { yyerrok; }
#line 1481 "y.tab.cc" /* yacc.c:1646  */
    break;

  case 9:
#line 273 "shell.y" /* yacc.c:1646  */
    {
    Shell::_currentCommand.
    insertSimpleCommand( Command::_currentSimpleCommand );
  }
#line 1490 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 1514 "y.tab.cc" /* yacc.c:1646  */
    break;

  case 14:
#line 305 "shell.y" /* yacc.c:1646  */
    {
...
#line 1527 "y.tab.cc" /* yacc.c:1646  */
    break;

  case 15:
#line 313 "shell.y" /* yacc.c:1646  */
    {
...
#line 1542 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 1553 "y.tab.cc" /* yacc.c:1646  */
    break;

  case 17:
#line 329 "shell.y" /* yacc.c:1646  */
    {
    //printf("   Yacc: insert both \"%s\"\n", $2->c_str());
    Shell::_currentCommand._outFile = (yyvsp[0].cpp_string);
    Shell::_currentCommand._errFile = (yyvsp[0].cpp_string);
  }
#line 1563 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 1572 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 1581 "y.tab.cc" /* yacc.c:1646  */
    break;
...
#line 1589 "y.tab.cc" /* yacc.c:1646  */
    break;


#line 1593 "y.tab.cc" /* yacc.c:1646  */
      default: break;
    }
